...
const std::map<SolutionsId, ProblemType> kPidToType{
    ...
    { SolutionsId::GENERATE_TREES, ProblemType::TREE },
    { SolutionsId::NUM_TREES, ProblemType::DYNAMIC_PROGRAMMING },
    { SolutionsId::RECOVER_TREE, ProblemType::TREE },
    { SolutionsId::IS_SAME_TREE, ProblemType::TREE },
    { SolutionsId::ZIGZAG_LEVEL_ORDER, ProblemType::TREE },
    ...
    { SolutionsId::IMAGE_SMOOTHER, ProblemType::ARRAY },
    { SolutionsId::FIND_SECOND_MINIMUM_VALUE, ProblemType::TREE },
    { SolutionsId::KNIGHT_PROBABILITY, ProblemType::DYNAMIC_PROGRAMMING },
    { SolutionsId::SEARCH_BST, ProblemType::TREE },
    { SolutionsId::IS_ONE_BIT_CHARACTER, ProblemType::ARRAY },
    { SolutionsId::LONGEST_WORD, ProblemType::STR },
